...
public class License extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        editViewlicenseType = (EditText)findViewById(R.id.editViewlicenseType);
    ...
    private void postDataToSQLite() {
        ...
        boolean insertdata = db.insertDataLice(editViewFirstName.getText().toString().trim(),editViewLastName.getText().toString().trim(),editViewAddress.getText().toString().trim(),editViewDOB.getText().toString().trim(),editViewlicenseType.getText().toString().trim());
        if(insertdata == true)
        {
            clear();
            Toast.makeText(License.this, "Data Saved ", Toast.LENGTH_SHORT).show();

        }
        else
        {
            clear();
            Toast.makeText(License.this, "Data Not Saved", Toast.LENGTH_SHORT).show();
        }
    ...
    public void clear()
    {
        ...
        editViewlicenseType.getText().clear();
    }
